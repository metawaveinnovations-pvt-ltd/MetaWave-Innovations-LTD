...
export function Hero({ onCtaclick }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-[80vh] lg:min-h-[88vh] pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-24 lg:pb-32 flex items-center bg-white overflow-hidden">
      
      {/* Decorative premium background lights, light mode themed */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10 bg-gradient-to-b from-[#F8FAFC] via-white to-white">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 space-y-7 text-left lg:-mt-10">
