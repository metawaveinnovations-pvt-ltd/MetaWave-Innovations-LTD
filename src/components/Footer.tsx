      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 pb-16">
          ...
          <div className="lg:col-span-2 space-y-5 text-left">
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-500 via-teal-600 to-emerald-800 p-[1.5px] shadow-sm">
                <div className="w-full h-full bg-white rounded-[10px] flex items-center justify-center">
                  <MetaWaveLogo size={18} />
                </div>
              </div>
              <div>
                <span className="font-sans font-extrabold text-sm tracking-tight text-white group-hover:text-emerald-450 transition-colors">
                  MetaWave
                </span>
                <span className="block text-[8px] font-mono tracking-widest text-emerald-450 uppercase leading-none mt-0.5 font-black">
                  Innovations
                </span>
              </div>
            </button>
