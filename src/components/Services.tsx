...
export function Services() {
  ...
  return (
    <section id="capabilities" className="py-24 bg-[#F8FAFC] border-b border-slate-200/50 relative overflow-hidden">
            ...
            >
              ...
              <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {currentGroup.subservices.map((sub, sIdx) => (
                  <div 
                    key={sIdx} 
                    className="p-4 rounded-xl border border-slate-150 bg-slate-50/50 hover:bg-white hover:border-slate-300 transition-all duration-300 pointer group/sub text-left space-y-1.5"
                  >
