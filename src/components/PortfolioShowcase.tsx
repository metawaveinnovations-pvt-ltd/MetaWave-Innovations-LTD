...
export function PortfolioShowcase() {
  ...
  return (
    <section id="portfolio" className="py-24 bg-white border-b border-slate-200/50 relative overflow-hidden">
      
      {/* Decorative grids */}
      <div className="absolute inset-0 pointer-events-none -z-10 bg-gradient-to-b from-white via-slate-50/40 to-white" />
