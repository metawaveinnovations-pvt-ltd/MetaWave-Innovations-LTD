...
export function FeaturedSolutions({ onCtaclick }: FeaturedSolutionsProps) {
  ...
  return (
    <section id="solutions" className="py-24 bg-white border-b border-slate-200/50 relative overflow-hidden">
      
      {/* Delicate layout grids */}
      <div className="absolute inset-0 pointer-events-none -z-10 bg-gradient-to-b from-white via-slate-50/30 to-white" />
