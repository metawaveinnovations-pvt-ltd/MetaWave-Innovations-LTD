    ...
    >
      ...
      <div className="w-[94%] xl:w-[90%] max-w-7xl mx-auto flex items-center justify-between relative h-full">
        ...
        <div className="flex items-center gap-3 shrink-0 justify-end">
          ...
          {/* SLA secure node identifier */}
          <span className="hidden md:inline text-[9px] font-mono font-bold text-emerald-100/80 border border-emerald-500/20 bg-emerald-950/20 px-2 py-0.5 rounded uppercase leading-none mt-0.5">
            NODE.SECURE
          </span>
