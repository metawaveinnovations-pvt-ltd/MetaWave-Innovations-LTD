...
export function Careers() {
  ...
  return (
    <section id="careers" className="py-24 bg-white border-b border-slate-200/50 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none -z-10 bg-gradient-to-b from-[#F8FAFC]/30 via-white to-white" />
